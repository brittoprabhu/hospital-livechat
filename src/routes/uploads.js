...
export default function UploadRoutes(pool, rootDir) {
  ...
  try {
    if (!rootDir) throw new Error('UploadRoutes: rootDir is undefined');
    ...
    console.error('[UploadRoutes Init Error]', err.message);
    return undefined; // <-- This is what breaks Express if not checked
  }
}
